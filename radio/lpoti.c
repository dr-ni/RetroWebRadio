...
#define DT_L 3//GPIO3 (P15)  amber
#define CLK_L 2//GPIO2 (P13) grey
#define SW_L 25 //GPIO25 (P37) blue
...
//        fprintf(stderr, "x");
        if(digitalRead(DT_L) && digitalRead(CLK_L))  {
            state_3 = STATE_NONE;
        }
...
int main() {
    ...
    wiringPiISR (DT_L, INT_EDGE_BOTH, interrupt_LRot) ;
    wiringPiISR (CLK_L, INT_EDGE_BOTH, interrupt_LRot) ;
    wiringPiISR (SW_L, INT_EDGE_FALLING, interrupt_LPush) ;
